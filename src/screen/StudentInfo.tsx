...
type StudentInfoScreenNavigationProp = StackNavigationProp<RootStackParamList, 'StudentInfo'>;

const StudentInfo = () => {
    const navigation = useNavigation<StudentInfoScreenNavigationProp>();
  ...
  return (
   ...
   {/* Roles */}
    ...
    <View style={styles.gridContainer}>
      ...
      <Text style={styles.label}>Whats your School/Colleage name?</Text>
      <TextInput

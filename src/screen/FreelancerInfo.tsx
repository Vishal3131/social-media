...
type FreelancerInfoScreenNavigationProp = StackNavigationProp<RootStackParamList, 'FreelancerInfo'>;

const FreelancerInfo = () => {
    const navigation = useNavigation<FreelancerInfoScreenNavigationProp>();

...
type EmployeeInfoScreenNavigationProp = StackNavigationProp<RootStackParamList, 'EmployeeInfo'>;

const EmployeeInfo = () => {
    const navigation = useNavigation<EmployeeInfoScreenNavigationProp>();
  ...
  return (
   ...
   {/* Roles */}
    ...
    <View style={styles.gridContainer}>
      ...
      <Text style={styles.label}>What's your role there?</Text>
      <TextInput
